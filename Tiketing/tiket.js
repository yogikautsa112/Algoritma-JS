...
document.write(`Keuntungan VIP = ${keuntunganVip}% <br>
Keuntungan Eksekutif = ${keuntunganEKS}% <br>
Keuntungan Ekonomi = ${keuntunganEKO}% <br>
Keuntungan Total = ${totalUntung}% <br> <hr>
Jumlah tiket VIP = ${VIP} <br>
Jumlah tiket Eksekutif = ${eksekutif} <br>
Jumlah tiket Ekonomi = ${ekonomi} <br>
Total tiket dari seluruh kelas = ${totalTiket}`)